Diferença entres os tipos de dados char e varchar:

CHAR: tamanho fixo em disco - 

Vantagem: Mais rápido para as pesquisas.

Desvantagem: Quando mau utilizado pode reservar espaço em disco de forma desnecessária.

VARCHAR: tamanho variável em disco -
